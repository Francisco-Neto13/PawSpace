...
import type { PawSpaceSkillNodeInput, SkillMutationInput } from './skills/mutations';
...
export async function savePawSpaceChanges(nodes: PawSpaceSkillNodeInput[]) { return mutations.savePawSpaceChanges(nodes); }
