...
export default function LibraryPage() {
  ...
  return (
    <div className="relative min-h-screen w-full overflow-x-hidden">
      <PageBackground src="/backgrounds/pages/cat3.webp" />
      ...
      <div className="relative z-10 py-8 pb-20">
        <div className="relative mx-auto max-w-6xl space-y-5 px-4 sm:px-6 xl:max-w-7xl xl:px-10 2xl:max-w-[1600px] 2xl:px-16">
          ...
          <div className="grid grid-cols-1 xl:grid-cols-[300px_minmax(0,1fr)] gap-4 items-start">
            ...
            <main
              className="library-panel relative overflow-hidden flex flex-col min-h-[60dvh] xl:min-h-[calc(100dvh-var(--navbar-height)-140px)] reveal-up delay-300"
            >
              <div className="absolute top-0 left-0 right-0 h-[1px] bg-gradient-to-r from-transparent via-[var(--shimmer-via)] to-transparent" />
