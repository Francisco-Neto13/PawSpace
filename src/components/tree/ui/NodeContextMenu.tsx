      ...
      <div className="relative min-w-[220px] rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-base)] overflow-hidden shadow-2xl">
        ...
        <div className="px-4 pt-4 pb-3 border-b border-[var(--border-subtle)] relative z-10">
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="field-label text-[var(--text-secondary)]">
              Trilha selecionada
            </p>
          </div>
          <p className="sidebar-title truncate pl-3">{nodeName}</p>
        </div>
        ...
        <div className="py-1.5 relative z-10">
          ...
          >
            ...
            <span className="button-label">Editar trilha</span>
          </button>
          ...
          >
            ...
            <span className="button-label">Adicionar subtrilha</span>
          </button>
          ...
          {onDelete && (
            <>
              ...
              >
                ...
                <span className="button-label">Remover trilha</span>
              </button>
            </>
          )}
        </div>
