    ...
    <section className="library-panel p-6 relative overflow-hidden">
      ...
      <div className="flex items-start gap-5">
        <div className="shrink-0">
          ...
          <p className="ui-meta uppercase text-center mt-1.5">Avatar</p>
        </div>
        ...
        <div className="flex-1 space-y-4">
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              {saved && !error && <p className="feedback-text text-[var(--text-secondary)]">Perfil do PawSpace atualizado.</p>}
            </div>
            <button
