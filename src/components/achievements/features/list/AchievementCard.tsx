...
function AchievementCardComponent({ achievement }: AchievementCardProps) {
  ...
  return (
    <article
      className={`relative library-panel p-4 md:p-5 overflow-hidden flex flex-col gap-4 h-full transition-colors duration-200 render-isolate ${
    ...
    >
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0">
          <h3
            className="sidebar-title leading-tight mb-1"
