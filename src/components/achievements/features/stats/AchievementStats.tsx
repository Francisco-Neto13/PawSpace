  ...
  return (
    <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
      <article className="library-panel p-5 relative overflow-hidden">
        ...
        <p className="metric-value font-mono tabular-nums mb-2">
      ...
      <article className="library-panel p-5 relative overflow-hidden">
        ...
        <p className="metric-value font-mono tabular-nums mb-3">
          {completionPct}
          <span className="text-sm text-[var(--text-secondary)] ml-0.5">%</span>
        </p>
