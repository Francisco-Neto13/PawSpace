...
const StarFieldComponent = () => {
  ...
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none overflow-hidden bg-[#06090f]" style={{ zIndex: 0 }}>
      ...
      <div className="absolute top-0 left-0 w-32 h-32 border-t border-l border-[#2dd4bf]/10 m-8" />
      <div className="absolute top-0 right-0 w-32 h-32 border-t border-r border-[#2dd4bf]/10 m-8" />
      <div className="absolute bottom-0 left-0 w-32 h-32 border-b border-l border-[#2dd4bf]/10 m-8" />
      <div className="absolute bottom-0 right-0 w-32 h-32 border-b border-r border-[#2dd4bf]/10 m-8" />
