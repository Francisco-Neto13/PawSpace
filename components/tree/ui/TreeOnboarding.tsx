...
const steps = [
  ...
  },
  {
    ...
    title: 'Seleção de Nó',
    desc: 'Clique esquerdo em um nó para selecioná-lo. As conexões relacionadas são destacadas e um resumo aparece no canto.',
  },
  {
    icon: <MousePointer2 size={13} />,
    title: 'Menu do Módulo',
    desc: "Botão direito em um nó para abrir ações como 'Adicionar Submódulo', 'Configurar Módulo' e remoção.",
  },
  {
    icon: <Edit3 size={13} />,
    title: 'Customização',
    desc: "Botão direito > 'Configurar Módulo' para alterar nome, ícone e cor do nó.",
  },
  {
    icon: <Move size={13} />,
    title: 'Navegação',
    desc: 'Arraste nós para organizar. Scroll para zoom e arraste o fundo para mover a câmera.',
  },
  {
    icon: <Save size={13} />,
    title: 'Sincronização',
...
export function TreeOnboarding() {
  ...
  return (
    <div className="fixed top-24 right-6 z-[60] flex flex-col items-end gap-2">
      ...
      {isOpen && (
        <div className="w-72 rounded-2xl border border-[var(--border-subtle)] bg-[var(--bg-surface)] overflow-hidden animate-in fade-in zoom-in-95 duration-200 origin-top-right shadow-2xl">
