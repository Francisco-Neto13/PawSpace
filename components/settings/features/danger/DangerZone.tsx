      ...
      <div className="border border-red-500/[0.16] rounded-xl bg-[var(--bg-elevated)] p-4">
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            disabled={isDeleting}
            className="h-9 shrink-0 flex items-center gap-1.5 px-3 rounded-xl border border-red-500/20 text-[9px] font-black uppercase tracking-wider text-red-400/65 hover:text-red-400/90 hover:border-red-500/40 transition-all duration-200 disabled:opacity-50"
          >
            <Trash2 size={10} />
            Deletar
          </button>
          ...
          <div className="mt-4 pt-4 border-t border-red-500/[0.12]" style={{ animation: 'slideDown 0.2s ease-out' }}>
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="flex-1 h-10 bg-[var(--bg-input)] border border-red-500/[0.18] rounded-xl px-3 text-[var(--text-primary)] text-[11px] font-bold tracking-widest outline-none focus:border-red-500/40 transition-colors placeholder:text-[var(--text-faint)] uppercase disabled:opacity-60"
              />
              <button
            ...
            {error && (
              <p className="mt-3 text-[9px] text-red-400/90 font-bold leading-relaxed">
                {error}
              </p>
            )}
          </div>
