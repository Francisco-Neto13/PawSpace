...
const Footer = forwardRef<HTMLElement>((_, ref) => {
  ...
  return (
    <footer
      ref={ref}
      className="w-full border-t border-[var(--border-subtle)] bg-[var(--bg-strong)] backdrop-blur-xl transition-all duration-300"
    >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 md:gap-0 relative">
          ...
          <div className="flex items-center gap-6 order-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all duration-300 hover:scale-110"
            >
              <Github size={18} />
            </a>
            <a
